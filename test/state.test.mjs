...
test('server calculation exposes current and repriced profit',()=>{
  const fields=calculateManualFields({...item,averageCNY:null},{purchaseCNY:30,manualFeeCNY:10,shippingJPY:210},{exchangeRate:22.99,costMultiplier:1.05,profitWarningJPY:1500});
